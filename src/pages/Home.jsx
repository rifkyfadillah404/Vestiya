...
export default function Home() {
  ...
  return (
    <div className="space-y-16">
      {/* Hero section */}
      <section className="hero-edge overflow-hidden bg-gradient-to-br from-neutral-50 to-neutral-200 border-y border-neutral-200 py-16 px-4 sm:px-6 text-center">
      ...
      <section className="space-y-6">
        ...
        {loading ? (
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            {featured.map((p) => (
              <article key={p.id} className="group card card-hover overflow-hidden">

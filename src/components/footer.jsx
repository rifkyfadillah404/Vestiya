    ...
    <footer className="border-t border-neutral-200 bg-white/80 backdrop-blur">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="text-center sm:text-left">
          ...
          <p className="text-xs text-neutral-500">Gaya minimal untuk keseharianmu.</p>
        </div>
        <div className="flex items-center gap-2 sm:gap-3">
          <a className="btn btn-ghost ring-focus" href="#" aria-label="Instagram">
          ...
          <a className="btn btn-ghost ring-focus" href="#" aria-label="Facebook">
          ...
          <a className="btn btn-ghost ring-focus" href="#" aria-label="Twitter">
            <svg className="icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
